...
class DQN(object):
    def __init__(self, args):  # 定义DQN的一系列属性
        ...
        self.tech_indicator_list = np.load(r"C:\Users\KIIT\Downloads\MacroHFT\data\feature_list\single_features.npy", allow_pickle=True).tolist()
        self.tech_indicator_list_trend = np.load(r"C:\Users\KIIT\Downloads\MacroHFT\data\feature_list\trend_features.npy", allow_pickle=True).tolist()
